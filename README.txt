...
2. Ensure that users are on the same connected WiFi network.

3. Change SERVER variable to the network ip address (e.g. school network) with "" surrounding it.

4. Select one computer to host the network, and run 'server.py' (ONLY 1 COMPUTER PER NETWORK).
